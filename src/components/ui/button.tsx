  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-semibold ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-sunset text-white shadow-glow hover:shadow-pop hover:scale-[1.03] active:scale-[0.98] transition-bounce font-semibold",
        whatsapp: "bg-whatsapp text-whatsapp-foreground hover:bg-whatsapp/90 active:scale-[0.98] shadow-card",
        glass: "glass text-white hover:bg-white/20",
        "outline-sunset":
          "border border-transparent [background:linear-gradient(hsl(var(--background)),hsl(var(--background)))_padding-box,var(--gradient-sunset)_border-box] text-foreground hover:shadow-glow",
